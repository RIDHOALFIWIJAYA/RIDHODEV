          ...
          <div className="flex-1 text-center lg:text-left z-10">
            ...
            <FadeIn delay={0.6}>
              <p className="text-xl text-slate-600 dark:text-slate-400 mb-10 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                Hi, I'm <span className="font-bold text-slate-900 dark:text-blue-400">Ridho</span>. a Frontend Developer passionate about crafting fast, responsive, and engaging web applications with JS Framework & modern web tools.
              </p>
            </FadeIn>
